    ...
    <ul class="dropdown clearfix gradient" style="width:100%;">
        ...
        <li class="menu-level-0 parent"><a href="#" hidefocus="true" style="outline: none;" class="gradient"><span>Tools</span></a>
            <ul class="submenu-1">
                ...
                <li class="menu-level-1"><a href="/controller/create-worksOn.php" hidefocus="true" style="outline: none;" class="gradient">View All WorksOn Records</a></li>
                <li class="menu-level-1"><a href="/controller/create-dependent.php" hidefocus="true" style="outline: none;" class="gradient">Create Dependants</a></li>
